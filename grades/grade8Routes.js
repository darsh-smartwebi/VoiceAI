...
function loadPdfTableOnce() {
  const csv = fs.readFileSync("./csv/grade8.csv", "utf8");
  ...
  console.log(`✅ Loaded ${PDF_TABLE.length} PDFs from grade8.csv`);
}
...
function scoreMatch(search, candidate) {
  ...
  const important = [
    ...
    "student edition volume 2 module 3",
    ...
    "teacher edition volume 2 module 3",
