...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .waveform-label { margin-left: 10px; font-size: 10px; font-weight: 500; color: rgba(255,255,255,0.55); letter-spacing: 0.06em; text-transform: uppercase; }
    ...
    .doc-filename { font-size: 13px; font-weight: 600; color: #1A4D55; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 200px; }
    .doc-filetype { display: inline-flex; align-items: center; margin-top: 4px; background: rgba(46,159,175,0.12); border-radius: 4px; padding: 2px 8px; }
    ...
    .how-title { font-size: 10px; font-weight: 600; color: #9EC8CE; letter-spacing: 0.1em; text-transform: uppercase; margin-bottom: 16px; }
    ...
    .signoff {
      ...
      padding-top: 20px; border-top: 1px solid #EAF5F7;
    }
    .signoff-left { display: flex; align-items: center; gap: 11px; }
    .signoff-avatar {
      width: 36px; height: 36px;
      background: linear-gradient(135deg, #2E9FAF, #3BBDCC);
      border-radius: 50%;
      display: flex; align-items: center; justify-content: center;
      box-shadow: 0 3px 10px rgba(46,159,175,0.3);
    }
    .signoff-avatar svg { width: 18px; height: 18px; }
    .signoff-name { font-size: 13px; font-weight: 600; color: #1A4D55; }
    .signoff-role { font-size: 11px; font-weight: 300; color: #9EC8CE; margin-top: 1px; }
    .signoff-time { font-size: 11px; font-weight: 300; color: #B5D9DE; }
